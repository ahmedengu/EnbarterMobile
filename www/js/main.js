...
app.controller('header', function ($scope, $location, $rootScope) {
    ...
    $scope.browseLink = "index.html#/browse";
    $scope.createBarterLink = "index.html#/create_barter";
    $scope.dashboardLink = "index.html#/dashboard";
    ...
    $scope.startBarter = function () {
        ...
        barter.save(null, {
            success: function (barter) {
                ...
                window.location.href = "index.html#/barter/" + barter.id;
            },
...
app.controller('indexCtrl', function ($scope, $location, $rootScope, $routeParams) {
    $scope.catSoft = "index.html#/browse/0NFJVql0U9";
    $scope.catWrite = "index.html#/browse/zSBhtFd8ZE";
    $scope.catMedia = "index.html#/browse/Wb8uqGgkdG";
    $scope.catData = "index.html#/browse/4TtjWA9W5e";
    $scope.catMarket = "index.html#/browse/7lY1lEwRny";
    $scope.catOther = "index.html#/browse/U8MCGz0C2B";
    ...
    query.get($routeParams.id, {
        success: function (result) {
            if (!result.get('barterUpUser') && Parse.User.current().id != result.get('user').id) {
                ...
                window.location.href = "index.html#/barter/" + result.id;
                return;
            }
